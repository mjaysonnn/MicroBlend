...
class WriteUserTimeline_args(object):
    ...
    def write(self, oprot):
        ...
        if self.carrier is not None:
            ...
            for kiter479, viter480 in self.carrier.items():
                oprot.writeString(kiter479.encode('utf-8') if sys.version_info[0] == 2 else kiter479)
                oprot.writeString(viter480.encode('utf-8') if sys.version_info[0] == 2 else viter480)
            oprot.writeMapEnd()
            oprot.writeFieldEnd()
...
class ReadUserTimeline_args(object):
    ...
    def write(self, oprot):
        ...
        if self.carrier is not None:
            oprot.writeFieldBegin('carrier', TType.MAP, 5)
            oprot.writeMapBegin(TType.STRING, TType.STRING, len(self.carrier))
            for kiter488, viter489 in self.carrier.items():
