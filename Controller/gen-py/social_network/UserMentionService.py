...
class ComposeUserMentions_args(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i578 in range(_size574):
                        ...
                        self.usernames.append(_elem579)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 3:
    ...
    def write(self, oprot):
        ...
        if self.carrier is not None:
            ...
            for kiter588, viter589 in self.carrier.items():
                oprot.writeString(kiter588.encode('utf-8') if sys.version_info[0] == 2 else kiter588)
                oprot.writeString(viter589.encode('utf-8') if sys.version_info[0] == 2 else viter589)
            oprot.writeMapEnd()
            oprot.writeFieldEnd()
