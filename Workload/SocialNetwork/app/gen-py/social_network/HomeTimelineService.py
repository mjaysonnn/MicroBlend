...
class ReadHomeTimeline_args(object):
    ...
    def write(self, oprot):
        ...
        if self.carrier is not None:
            ...
            for kiter447, viter448 in self.carrier.items():
...
class WriteHomeTimeline_args(object):
            ...
            if fid == 1:
                ...
                if ftype == TType.LIST:
                    ...
                    for _i460 in range(_size456):
                        ...
                        self.user_mentions_id.append(_elem461)
                    iprot.readListEnd()
                else:
                    iprot.skip(ftype)
            elif fid == 6:
    ...
    def write(self, oprot):
        ...
        if self.user_mentions_id is not None:
            ...
            for iter469 in self.user_mentions_id:
        ...
        if self.carrier is not None:
            ...
            oprot.writeMapBegin(TType.STRING, TType.STRING, len(self.carrier))
            for kiter470, viter471 in self.carrier.items():
                oprot.writeString(kiter470.encode('utf-8') if sys.version_info[0] == 2 else kiter470)
                oprot.writeString(viter471.encode('utf-8') if sys.version_info[0] == 2 else viter471)
            oprot.writeMapEnd()
            oprot.writeFieldEnd()
        oprot.writeFieldStop()
        oprot.writeStructEnd()
